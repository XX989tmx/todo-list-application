...
var Todo = /** @class */ (function () {
    ...
    function Todo(title, notes, priority, scheduledDate, deadline, isDone, userId) {
        this.id = null;
    ...
    Todo.createTodoSchemaInstance = function () {
        var todoSchemaInstance = new TodoSchema({
            title: null,
            notes: null,
            priority: null,
            dateCreated: null,
    ...
    Todo.saveToDatabase = function (todo) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        createdTodoSchema = new TodoSchema({
                            title: todo.title,
                            notes: todo.notes,
...
var Today = /** @class */ (function () {
    ...
    Today.prototype.completeTodo = function (id) {
        for (var i = 0; i < this.list.length; i++) {
            if (this.list[i].toString() === id.toString() &&
    ...
    Today.prototype.getTodaysTodoFromAll = function (todoAll) {
        ...
        for (var _i = 0, todoAll_1 = todoAll; _i < todoAll_1.length; _i++) {
            var todo_1 = todoAll_1[_i];
            var todoDate = todo_1.scheduledDate.getDate();
            if (todoDate === today) {
                this.todaysList.push(todo_1);
                this.size++;
            }
        }
        return this;
    ...
    Today.createTodaySchemaInstance = function () {
        var todaySchemaInstance = new todaySchema({
            todaysList: [],
            userId: null,
        });
...
var Inbox = /** @class */ (function () {
    ...
    Inbox.prototype.addNewTodo = function (title, notes, priority, scheduledDate, deadline) {
        var todo = new Todo();
        var newTodo = todo.set(title, notes, priority, scheduledDate, deadline);
        console.log(newTodo);
        this.add(newTodo);
        return this;
    };
    ...
    Inbox.createInboxSchemaInstance = function () {
        var inboxSchemaInstance = new InboxSchema({
            list: [],
            size: 0,
            userId: null,
        });
    ...
    Inbox.saveInboxData = function (inboxInstance) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        createdInboxSchema = new InboxSchema({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, InboxSchema.findById(inboxId)];
                    case 1:
                        inboxData = _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
...
var Project = /** @class */ (function () {
    function Project(title, notes, isDone, dateCreated, deadLine, scheduledDate) {
        this.todoLists = [];
        this.title = null;
        this.notes = null;
        this.isDone = false;
    ...
    Project.prototype.getProgressStatus = function (params) {
    ...
    Project.prototype.getCountOfCompletedTodo = function () {
        ...
        for (var i = 0; i < allTodo.length; i++) {
            var todo_3 = allTodo[i];
            if (todo_3.isDone === true) {
                count += 1;
            }
        }
        return count;
    };
    Project.prototype.getCurrentProgressPercentage = function (params) {
    ...
    Project.prototype.updateProgressStatus = function (params) {
    ...
    Project.createProjectSchemaInstance = function () {
        var projectSchemaInstance = new ProjectSchema({
            todoLists: [],
            title: null,
            notes: null,
            isDone: null,
...
var Activity = /** @class */ (function () {
    ...
    Activity.prototype.isInRow = function (todoDoc) {
        var id = todoDoc.id;
        var oldToNewSortedArr = this.accomplishedTodo.sort(function (a, b) { return a.date - b.date; });
        var count = 0;
        for (var i = id; i < oldToNewSortedArr.length; i--) {
    ...
    Activity.prototype.getInRowDuration = function (todoDoc) {
        ...
        var count = 0;
        for (var i = idxOfTargetDocId; i < oldToNewSortedArr.length; i--) {
            if (oldToNewSortedArr[i].productivityScore > 10) {
                count += 1;
            }
            else {
    ...
    Activity.prototype.getLongestInRowDuration = function (todoDoc) {
        ...
        var maxInRow = Math.max.apply(Math, countArr);
        return maxInRow;
    };
    ...
    Activity.createActivitySchemaInstance = function () {
        var activitySchemaInstance = new ActivitySchema({
            date: null,
            accomplishedTodo: [],
            accomplishedCount: 0,
            productivityScore: 0,
...
var Logbook = /** @class */ (function () {
    ...
    Logbook.createLogbookSchemaInstance = function () {
        var logbookSchemaInstance = new LogbookSchema({
            list: [],
            size: 0,
        });
...
var TrashBox = /** @class */ (function () {
    ...
    TrashBox.createTrashBoxSchemaInstance = function () {
        var trashBoxSchemaInstance = new TrashBoxSchema({
            list: [],
            size: 0,
        });
